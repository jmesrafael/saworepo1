...
const FIXED_ORDER = ["Thermometers", "Combined Meters", "Hygrometers"];
const GROUP_KEYWORDS = {
  "Thermometers":    ["Thermometer"],
  "Combined Meters": ["Combined", "Combi Meter"],
  ...
  return (
    <div className="relative">
      ...
      <section className="relative min-h-[95vh] flex flex-col justify-center items-center text-center px-6">
        <img src={heroImg} alt="Thermometers and Combined Meters" className="absolute inset-0 w-full h-full object-cover object-center -z-10" loading="eager" fetchPriority="high" decoding="sync" />
        ...
        <div className="wm-container">
          <div className="wm-why-grid">
            <div className="wm-why-left">
              ...
              <h2 className="wm-why-title">Why Choose SAWO Thermometers</h2>
              <p className="wm-why-desc">SAWO thermometers and hygrometers are crafted for accuracy and longevity in high-heat, high-humidity environments. Monitor your sauna with confidence using instruments built to last.</p>
