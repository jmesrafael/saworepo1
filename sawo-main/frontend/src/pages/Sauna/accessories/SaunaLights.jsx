...
export default function SaunaLights() {
        ...
        <div className="wm-container">
          <div className="wm-why-grid">
            <div className="wm-why-left">
              ...
              <h2 className="wm-why-title">Why Choose SAWO Lighting</h2>
              <p className="wm-why-desc">SAWO sauna lights and covers are built for the demanding sauna environment — heat-resistant, moisture-proof, and beautifully designed to elevate your relaxation space.</p>
