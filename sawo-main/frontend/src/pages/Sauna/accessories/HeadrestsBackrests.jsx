...
const DISPLAY_CATEGORIES = ["Headrests", "Backrests", "Headrest & Backrest"];
const DISPLAY_TAGS       = ["Headrest & Backrest"];

const FIXED_ORDER = ["Headrests", "Backrests"];
...
export default function HeadrestsBackrests() {
  ...
  return (
    <div className="relative">
      ...
      <section className="relative min-h-[95vh] flex flex-col justify-center items-center text-center px-6">
        <img src={heroImg} alt="Headrests and Backrests" className="absolute inset-0 w-full h-full object-cover object-center -z-10" loading="eager" fetchPriority="high" decoding="sync" />
          ...
          <div className="wm-container">
            <div className="wm-filter-search-row">
              ...
              <div className="wm-search-wrap wm-search-bar-fixed">
                ...
                <input className="wm-search-input" type="text" value={search} onChange={e => setSearch(e.target.value)} placeholder="Search headrests & backrests..." />
        ...
        <div className="wm-container">
          <div className="wm-why-grid">
            <div className="wm-why-left">
              ...
              <h2 className="wm-why-title">Why Choose SAWO Comfort Accessories</h2>
              <p className="wm-why-desc">SAWO headrests and backrests are crafted from premium wood and moisture-resistant materials, designed to provide lasting comfort in the high-heat sauna environment without compromising on style.</p>
