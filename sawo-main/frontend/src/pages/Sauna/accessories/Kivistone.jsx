...
import heroImg from "../../../assets/R-500-D_Scene2.webp";
import "../heaters/heaters.css";

const DISPLAY_CATEGORIES = ["Kivistone"];
const DISPLAY_TAGS       = ["Kivistone"];

const FIXED_ORDER = ["Kivistone"];
const GROUP_KEYWORDS = {
  "Kivistone": ["Kivistone", "Soapstone", "Kivi"],
};
...
export default function Kivistone() {
    ...
    <div className="relative">
      ...
      <section className="wm-section">
        <div className="wm-container text-center">
          <h2 className="wm-products-title">Kivistone Soapstone Collection</h2>
          <p className="wm-products-desc">Kivistone offers a variety of unique soapstone products for homes, gifts, and corporate use. Featuring a wide range of innovative designs, each piece brings the natural beauty and heat-retaining properties of Finnish soapstone into your daily life.</p>
        </div>
      </section>
          ...
          <div className="wm-container">
            <div className="wm-filter-search-row">
              ...
              <div className="wm-search-wrap wm-search-bar-fixed">
                ...
                <input className="wm-search-input" type="text" value={search} onChange={e => setSearch(e.target.value)} placeholder="Search Kivistone products..." />
        ...
        <div className="wm-container">
          <div className="wm-why-grid">
            <div className="wm-why-left">
              ...
              <h2 className="wm-why-title">Why Choose Kivistone</h2>
              <p className="wm-why-desc">Kivistone soapstone products are renowned for their natural heat retention, durability, and timeless Nordic aesthetic. Each piece is uniquely crafted, making them ideal gifts and home accessories that last a lifetime.</p>
