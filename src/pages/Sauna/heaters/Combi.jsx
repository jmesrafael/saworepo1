  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        setAllProducts(filterCombiProducts(data));
      } catch (err) {
        console.error("Combi: fetch failed", err);
      } finally {
        setLoading(false);
      }
    })();
    ...
    <div className="relative">
      <style>{`
        ...
        .wm-search-wrap {
          ...
          background: #fff; border: 1.5px solid #e0cfc0; border-radius: 40px;
          padding: 9px 18px; box-shadow: 0 2px 12px rgba(139,94,60,0.07);
